...
func init() {
	...
	url := flag.String("u", "ws://127.0.0.1:1217", "Set Url of WSClient.")
	// 默认昵称
	adana := flag.String("n", "藤原千花", "Set default nickname.")
	...
	// 通过代码写死的方式添加主人账号
	 sus = append(sus, 427706667)
	 sus = append(sus, 2831671380)
	...
	config.Z = zero.Config{
		NickName:       append([]string{*adana}, "书记", "日本首相", "千花", "藤原千花"),
